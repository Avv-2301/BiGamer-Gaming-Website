...
const Footer = () => {
    ...
    const handleNameChange = (e) => setNewsName(e.target.value);
    const handleEmailChange = (e) => setNewsEmail(e.target.value);
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="footer-bottom-content text-center">
                                <p>&copy;2022 <Link to="/">BiGamer</Link> - eSports And Gaming React Template.</p>
                            </div>
                        </div>
                    </div>
                </div>
