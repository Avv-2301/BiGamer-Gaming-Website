...
const desc = "Time : 08:30Pm   -  30 December 2022";
const btnText = "Watch Now";

function BannerSection(){
    return(
        <div>
          <section className="banner-section" style={{ backgroundImage: "url(/banner/bg.jpg)" }}>
                <div className="container">
                    <div className="">
                        <div className="banner-content text-center">
                            <h4 className="fw-normal theme-color mb-4">{title}</h4>
                            <img src="banner/01.png" alt="banner text thumb" className="mb-4" />
                            <p>{desc}</p>
                        ...
                        <div className="banner-thumb d-flex flex-wrap justify-content-center justify-content-between align-items-center align-items-lg-end">
                            <div className="banner-thumb-img ml-xl-50-none">
                                <Link to="/team-single"><img src="banner/02.png" alt="banner-thumb" /></Link>
                            </div>
                            <div className="banner-thumb-vs">
                                <img src="banner/vs.png" alt="banner-thumb" />
                            </div>
                            <div className="banner-thumb-img mr-xl-50-none">
                                <Link to="/team-single"><img src="banner/03.png" alt="banner-thumb" /></Link>
                            </div>
                        </div>
                    </div>
                </div>
