                            ...
                            <article>
                                ...
                                <div className="review">
                                    <ul className="review-nav RevActive lab-ul">
                                        <li onClick={descriptionShow} className="desc" data-target="description-show">Description</li>
                                        <li onClick={reviewShow} className="rev" data-target="review-content-show">Reviews 4</li>
                                    </ul>
